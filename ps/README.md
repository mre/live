`ps` is a Unix tool, which prints out the status of all process running on your computer.

Here's some sample output. The output can vary from your system.
...
On Linux, this output is generated from a file named `stat`, that will be created for every process running on your computer.

This is what it looks like, if I run `cat /proc/1/stat` on a Debian Stretch machine:

```
1 (bash) S 0 1 1 34816 7 4210944 884 0 0 0 1 2 0 0 20 0 1 0 709810 18563072 801 18446744073709551615 4194304 5242124 140727384146288 140727384144920 140018251182010 0 65536 3670020 1266777851 0 0 0 17 3 0 0 0 0 0 7341384 7388228 20779008 140727384153979 140727384153984 140727384153984 140727384154094 0
```

Quite intimidating, huh?

No worries.
Here is an explanation of the fields (taken from the [ps manpage](http://man7.org/linux/man-pages/man5/proc.5.html)):
...
Can you write a Rust program that reads the contents of `/proc/[pid]/stat`?   
If you feel fancy, maybe you even wanna try reproducing the output of `ps`?  

**The easiest way to get started is to use the sample data provided in the `/proc` folder. **


Alternatively, you could play around with a Docker container:
